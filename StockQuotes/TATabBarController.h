...
@interface TATabBarController : UIViewController <TATabBarDelegate, ListOfWatchlistsViewControllerProtocol> {
...
@property (readwrite, nonatomic, strong) id selectedViewController;
